    ...
    <div className="first-section max-w-[1880px] mx-auto ">
      ...
      <div className="">
        <div className="relative top-24 max-sm:top-[-50px]">
          <div className="flex justify-center gap-20 max-sm:flex max-sm:flex-col max-sm:justify-normal max-sm:gap-24 max-sm:p-4">
            ...
            <div className="text-side">
              <h1 className="headingText max-sm:p-4 gap-4  font-superLagend flex-col items-center text-4xl max-sm:text-xl tracking-[0.11em]">
                The Metaverse's <br />
                Game-Changer
              </h1>
              <p className="w-[35rem] text-[22px] leading-[36px] text-justify card-para  max-sm:w-full mt-6 max-sm:mt-4 max-sm:text-xl max-sm:p-4  max-sm:leading-relaxed text-lg font-superLagend">
